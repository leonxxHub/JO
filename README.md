shared.LoaderTitle = " Wait please....  Hub";
...
--     RolePlay Edit
--=====================--
local args = {"RolePlayName"," script Joao."}
...
local args = {"RolePlayBio","JOAO HUB"}
game:GetService("ReplicatedStorage"):WaitForChild("RE"):WaitForChild("1RPNam1eTex1t"):FireServer(unpack(args))
